...
For example, if we want to skip function \textit{f}, then it can be done by invoking the following command line:
...
\end{lstlisting}
We now give more details regarding the various command line options.
