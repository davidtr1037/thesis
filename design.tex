...
\caseof{Handling $\instruct{Call}$
  instructions}{(lines~\ref{alg:casecall-begin}--\ref{alg:casecall-end})}
...
\caseof{Handling $\instruct{Load}$
  instructions}{(lines~\ref{alg:caseload-begin}--\ref{alg:caseload-end})}
...
\caseof{Handling $\instruct{Branch}$
  instructions}{(lines~\ref{alg:casebranch-begin}--\ref{alg:casebranch-end})}
...
\caseof{Handling $\instruct{Store}$
  instructions}{(lines~\ref{alg:casestore-begin}--\ref{alg:casestore-end})}
...
\caseof{Handling $\instruct{Exit}$
  instructions}{(lines~\ref{alg:caseexit-begin}--\ref{alg:caseexit-end})}
The algorithm checks whether the current state $\workstate$ is a
