...
\subsection{Failure Reproduction}
...
\paragraph{Benchmarks} The subjects of this part of the evaluation are
...
\paragraph{Methodology} We proceed with the following evaluation
process:
...
\paragraph{Methodology} We proceed with the following
evaluation process:
